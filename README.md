...
- **Automatisk hentning af anmeldelser** via Google Places API, så I undgår at copy-paste manuelt. Kræver en Places API-nøgle (gratis tier er rigelig til at teste) og et kald til `places.googleapis.com` — kan tilføjes som et nyt endpoint i `server.js`.
